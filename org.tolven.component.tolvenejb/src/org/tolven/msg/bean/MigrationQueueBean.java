...
import org.tolven.msg.MigrationQueueLocal;
import org.tolven.naming.QueueContext;
import org.tolven.naming.TolvenContext;

@Stateless
@Local(MigrationQueueLocal.class)
public class MigrationQueueBean implements MigrationQueueLocal {
    ...
    public String getQueueName() {
        if (queueName == null) {
            try {
                queueName = migrationQueue.getQueueName();
    ...
    public void send(List<Serializable> payloads, List<Map<String, Object>> listOfProperties) {
        ...
        try {
            ...
            MessageProducer messageProducer = session.createProducer(migrationQueue);
