...
@Stateless
@Local(TouchQueueLocal.class)
public class TouchQueueBean implements TouchQueueLocal {
    ...
    public String getQueueName() {
        if (queueName == null) {
            try {
                queueName = touchQueue.getQueueName();
    ...
    public void send(List<Serializable> payloads, List<Map<String, Object>> listOfProperties) {
        ...
        try {
            ...
            MessageProducer messageProducer = session.createProducer(touchQueue);
