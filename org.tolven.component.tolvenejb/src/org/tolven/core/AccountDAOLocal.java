...
public interface AccountDAOLocal {
    ...
    /**
     ...
     public boolean addSystemUserToAccount(AccountUser accountUser,PrivateKey userPrivateKey, char[] inviterUserPassword);
     
     /**
      * @see AccountDAOBean
      */
     public AccountUser inviteAccountUser(Account account, AccountUser accountUser, TolvenUser invitedUser, String invitedUserRealm, PrivateKey anInviterPrivateKey, char[] inviterUserPassword, Date now, boolean accountPermission);
      ...
      */
     public AccountUser inviteAccountUser(Account account, AccountUser accountUser, TolvenUser invitedUser, String invitedUserRealm, PrivateKey anInviterPrivateKey, char[] inviterUserPassword, Date now, boolean accountPermission, boolean isReinvite);
