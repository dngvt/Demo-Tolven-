...
public class TolvenRequest {
    ...
    public static TolvenRequest getInstance() {
        TolvenRequest tolvenRequest = instance.get();
        if (tolvenRequest == null) {
            tolvenRequest = new TolvenRequest();
            instance.set(tolvenRequest);
        }
        return tolvenRequest;
    }
    ...
    private TolvenResourceBundle resourceBundle;
    ...
    public Locale getLocale() {
        ...
        if (locale == null) {
            ...
            if (getAccount() != null) {
                accountLocale = getAccount().getLocale();
            }
         
            if (userLocale == null || userLocale.isEmpty()) {
                if (accountLocale == null || accountLocale.isEmpty()) {
    ...
    public TolvenResourceBundle getResourceBundle() {
        ...
        if (resourceBundle == null) {
            ...
            resourceBundle = new TolvenResourceBundle(locale, parentBundles);
        }
