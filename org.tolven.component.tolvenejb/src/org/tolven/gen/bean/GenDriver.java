...
public class GenDriver implements MessageListener {
    ...
    private static Boolean uuidMrn;
    ...
    public void onMessage(Message msg) {
        try {
            ...
            if (((ObjectMessage) msg).getObject() instanceof GenControlFamily) {
                ...
                GenMedicalCCR generator = new GenMedicalCCR(control.getNow(), control.getStartYear(), isUuidMrn());
    ...
    private boolean isUuidMrn() {
        if(uuidMrn == null) {
            String uuidMrnValue = propertiesBean.getProperty("tolven.gen.patient.mrn.uuid"); 
            uuidMrn = uuidMrnValue != null && Boolean.TRUE.toString().equals(uuidMrnValue);
        }
        return uuidMrn;
    }
