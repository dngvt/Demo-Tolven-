...
//				continue;
	 ...
	 */
	private MenuData addTrimHeaderToMenu( Trim trim, TrimHeader trimHeader, String menuPath,Map<String,MenuDataVersionMessage> mdvs) {
		try {
	 ...
	 * @throws JAXBException 
	 */
	private void addTrimToMenus( TrimHeader trimHeader,Map<String,MenuDataVersionMessage> mdvs ) throws JAXBException {
		...
		if (trim.isAbstract()==null || !trim.isAbstract()) {
			...
			for (String menuPath : trim.getMenus()) {
				addTrimHeaderToMenu( trim, trimHeader, menuPath,mdvs);
			}
		}
