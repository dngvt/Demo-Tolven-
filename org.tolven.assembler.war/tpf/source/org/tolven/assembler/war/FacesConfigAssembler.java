 ...
 *
 * @author Joseph Isaac
 * @version $Id: FacesConfigAssembler.java 8732 2014-03-01 00:35:09Z joe.isaac@tolven.org $
 */
...
public class FacesConfigAssembler {
    ...
    protected boolean addApplicationChildren(PluginDescriptor pluginDescriptor, XMLStreamWriter xmlStreamWriter) throws XMLStreamException {
        ...
        for (Extension extension : getTolvenCommandPlugin().getExtensions(pluginDescriptor, "resource-bundle")) {
            xmlStreamWriter.writeStartElement("resource-bundle");
            xmlStreamWriter.writeCharacters("\n");
            xmlStreamWriter.writeStartElement("base-name");
            xmlStreamWriter.writeCharacters(extension.getParameter("base-name").valueAsString());
            xmlStreamWriter.writeEndElement();
            xmlStreamWriter.writeCharacters("\n");
            xmlStreamWriter.writeStartElement("var");
            xmlStreamWriter.writeCharacters(extension.getParameter("var").valueAsString());
            xmlStreamWriter.writeEndElement();
            xmlStreamWriter.writeCharacters("\n");
            xmlStreamWriter.writeEndElement();
            xmlStreamWriter.writeCharacters("\n");
