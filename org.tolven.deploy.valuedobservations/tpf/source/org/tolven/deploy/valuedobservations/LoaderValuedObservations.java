...
public class LoaderValuedObservations extends TolvenCommandPlugin {
    ...
    public void execute(String[] args) throws Exception {
        ...
        LoadValuedObservations loader = new LoadValuedObservations(getAdminId(), getAdminPassword(), getAppRestfulRootURL(), getAuthRestfulRootURL());
        File src = getFilePath("tpf/voc/valuedobservations.txt");
        logger.info("Load Observations from " + src.getPath() + "...");
        loader.load(src.getPath());
        logger.info("Load Observations completed");
