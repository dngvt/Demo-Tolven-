...
//import org.tolven.DMD.umls.rrf.columns.IMrConso;
//import org.tolven.DMD.umls.rrf.columns.IMrRel;
//import org.tolven.DMD.umls.rrf.columns.IMrSat;
/**
 * Read DMD RRF files and create Trim documents
 * @author John Churin
 *
 */
public class LoadDMD extends LoadRESTfulClient {
	String dirDMD;
	String dirTrim;
	String trimFileName;
...
//	Map<String, List<String>> mapIsA;
     ...
     */
    public LoadDMD(String userId, char[] password, String appRestfulURL, String authRestfulURL, String dirDMD ) {
...
//	}
	...
	/**
	 * Generate a single trim from the elements extracted from DMD 
	 * @param scdf
	 * @param trimWriter
...
//    	            	}
	...
	/**
	 * Read DMD and directly generate trim and upload to the server
	 * @param trimWriter
	 * @throws Exception
	 */
...
*/
	...
	public void uploadTrimsFile(String fileName) throws Exception {
        try {
            logger.info("Uploading DMD trims from " + fileName);
...
//                    if (Character.isWhitespace(c)) continue;
            ...
            logger.info("Count of DMD Med trims uploaded: " + rowCount);
	...
	/**
	 * Read DMD and create an intermediate file that can be used for to upload later
	 * @param trimWriter
	 * @throws Exception
	 */
/*	public void CreateTrimsFile( String fileName ) throws Exception {
		...
		writer.writeAttribute("type", "DMD");
...
*/
	/**
	 * Test the program
	 * @param args The directory containing DMD files and the directory containing the trim files to be
	 * created or updated.
	 * @throws Exception 
	 */
	public static void main(String[] args) throws Exception {
		...
		//LoadDMD m = new LoadDMD(args[0], args[0]);
		//m.login("admin", "sysadmin");
		//m.uploadTrimsFile(args[0]);
		//m.setup();
		//m.CreateTrimsFile("DMD.trims.xml");
		//m.generate();
	}

	public String getDirDMD() {
		return dirDMD;
	}

	public void setDirDMD(String dirDMD) {
		this.dirDMD = dirDMD;
	}
