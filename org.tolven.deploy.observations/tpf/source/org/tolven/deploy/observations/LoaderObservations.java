...
public class LoaderObservations extends TolvenCommandPlugin {
    ...
    public void execute(String[] args) throws Exception {
        ...
        LoadObservations loader = new LoadObservations(getAdminId(), getAdminPassword(), getAppRestfulRootURL(), getAuthRestfulRootURL());
        File src = getFilePath("tpf/voc/observations.txt");
