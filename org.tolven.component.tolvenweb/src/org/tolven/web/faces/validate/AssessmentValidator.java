 ...
 * added on 07/14/2010
 */
public class AssessmentValidator extends TolvenJSFFormValidator {
    ...
    public void validate(FacesContext context, UIComponent component, Object value) throws ValidatorException {
		if(!super.isCheckValidations(component, context)){
			System.out.println("validations are disabled");
			return;
		}
		CEEx ce = (CEEx) value;
