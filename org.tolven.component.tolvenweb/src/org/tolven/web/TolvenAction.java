...
public abstract class TolvenAction extends TolvenBean {
    ...
    protected Date getNow() {
    	if(this.now == null){
    		this.now = TolvenRequest.getInstance().getNow(); 
    	}
        return now;
    }
    ...
    public Locale getLocale() {
    	if(this.locale == null){
    		this.locale = TolvenRequest.getInstance().getLocale();
    	}
        return locale;
    }
   ...
   /**
    ...
    public AccountUser getAccountUser() {
    	if(this.accountUser == null){
    		this.accountUser = TolvenRequest.getInstance().getAccountUser();
    	}
    	return accountUser;
    }
    ...
    public TolvenUser getUser(){
    	if(this.user == null){
    		this.user = TolvenRequest.getInstance().getTolvenUser();
    	}
    	return this.user;
    }
    ...
    public TolvenResourceBundle getTolvenResourceBundle() {
    	if(this.tolvenResourceBundle == null){
    		this.tolvenResourceBundle = TolvenRequest.getInstance().getResourceBundle();
    	}
        return this.tolvenResourceBundle;
    }
    ...
    public String getTimeZone() {
    	if(this.timeZone == null){
    		this.timeZone = TolvenRequest.getInstance().getTimeZone();
    	}
    ...
    public TimeZone getTimeZoneObject() {
    	if(this.timeZoneObject == null){
    		this.timeZoneObject = TolvenRequest.getInstance().getTimeZoneObject();
    	}
    ...
    public String getTitlePrefix() {
        if(titlePrefix == null) {
            titlePrefix = getTolvenPersonString("givenName") + " " + getTolvenPersonString("sn");
        }
        return titlePrefix;
    }
    ...
    public String getInitialPage() {
        ...
        return getAccountUser().getOpenMeFirst() == null || getAccountUser().getOpenMeFirst().length() == 0 ? getAccountUser().getAccount().getAccountType().getKnownType() : getAccountUser().getOpenMeFirst();
    }

    public boolean getEnableBackButton() {
        return getAccountUser() != null && Boolean.TRUE.equals(Boolean.valueOf(getAccountUser().getAccount().getEnableBackButton()));
    }
