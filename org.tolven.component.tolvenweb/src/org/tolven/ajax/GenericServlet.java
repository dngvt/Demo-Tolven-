...
//		TolvenLogger.info(" Account User:  " + activeAccountUser, GenericServlet.class );
	    ...
	    Writer writer=resp.getWriter();
	    if (uri.endsWith("isAccountDataMigrationInProgress.ajaxc")) { ////to check account data migration progress
	    	resp.setContentType("text/plain");	
	    	writer.write(activeAccountUser.getAccount().getDataMigrationInProgress().toString());
	    }else if (uri.endsWith("getprovideroptions.ajaxc")) {
