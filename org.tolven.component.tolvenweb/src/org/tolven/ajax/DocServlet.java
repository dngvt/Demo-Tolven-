 ...
 * @throws IOException 
 */	
protected void returnXML(long docId, HttpServletRequest req, HttpServletResponse res) throws IOException {
	try {
		...
		docBean.returnXML(docId, req.getParameterMap(),req.getLocalAddr(),res.getWriter());		
	} catch (Exception e) {
		throw new RuntimeException("Unable to render XML document " +docId, e);
	}
}
...
//	writer.write("</html>\n");
	 ...
	 * @throws IOException 
	 */	
protected void returnImage(DocBase doc, HttpServletRequest req, HttpServletResponse res) throws IOException {
	AccountUser accountUser = TolvenRequest.getInstance().getAccountUser();
 ...
 * @throws IOException 
 */	
protected void returnApplication(DocBase doc, HttpServletRequest req, HttpServletResponse res) throws IOException {
	AccountUser accountUser = TolvenRequest.getInstance().getAccountUser();
    ...
    protected void returnContent(HttpServletRequest req, HttpServletResponse res) throws IOException {
